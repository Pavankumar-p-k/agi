        ...
        async with httpx.AsyncClient(timeout=httpx.Timeout(connect=30.0, read=300.0, write=30.0, pool=30.0)) as client:
            ...
            if resp.status_code != 200:
                ...
                try:
                    ...
                    logger.warning("[mcp.image_gen_server] generate_image failed: %s", e)
            ...
            if img.get("b64_json"):
                ...
                try:
                    ...
                    logger.warning("[mcp.image_gen_server] src.database not available: %s", e)
                    return TextContent(type="text", text=f"image saved at {image_url} (gallery unavailable)")
                try:
                    db = SessionLocal()
                    db.add(GalleryImage(
                        id=str(uuid.uuid4()),
                    ...
                    logger.warning("[mcp.image_gen_server] db_cleanup failed: %s", e)
