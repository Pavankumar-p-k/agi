...
class ReplyAgent {
  ...
  Future<void> openNotificationAccessSettings() async {
    try {
      await _replyChannel.invokeMethod('openNotificationAccessSettings');
    } catch (e) {
      debugPrint('[ReplyAgent] openNotificationAccessSettings error: $e');
    }
  }

  Future<void> openAccessibilitySettings() async {
    try {
      await _replyChannel.invokeMethod('openAccessibilitySettings');
    } catch (e) {
      debugPrint('[ReplyAgent] openAccessibilitySettings error: $e');
    }
  }

  Future<bool> isNotificationAccessEnabled() async {
    try {
      final result = await _replyChannel.invokeMethod<bool>('isNotificationAccessEnabled');
      return result ?? false;
    } catch (e) {
      debugPrint('[ReplyAgent] isNotificationAccessEnabled error: $e');
      return false;
    }
  }
  ...
  Future<bool> isAccessibilityEnabled() async {
    try {
      final result = await _replyChannel.invokeMethod<bool>('isAccessibilityEnabled');
      return result ?? false;
    } catch (e) {
      debugPrint('[ReplyAgent] isAccessibilityEnabled error: $e');
      return false;
    }
  }
  ...
  Future<void> _sendReply(InboxMessage msg, String reply) async {
    ...
    try {
      await _replyViaNotificationAction(
          msg.sender, msg.platform, msg.cacheKey, reply);
    } catch (e) {
  ...
  Future<bool> _replyViaNotificationAction(
      String sender, String platform, String cacheKey, String text) async {
    try {
      final result = await _replyChannel.invokeMethod<bool>('sendReply', {
        'sender': sender,
        'platform': platform,
        'cache_key': cacheKey,
        'text': text,
      ...
      debugPrint('[ReplyAgent] Notification action error: $e');
      return false;
    }
  }
