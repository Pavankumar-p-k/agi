...
//  â€¢ Live decision feed (what JARVIS is doing autonomously)
//  â€¢ Pattern visualizer (what it learned about you)
//  â€¢ Active goals + progress bars
//  â€¢ Prediction confidence display
//  â€¢ Self-improvement stats
//  â€¢ Controls (confidence threshold, DND, enable/disable)
        ...
        ...topIntents.map((item) {
          ...
          return Container(
            ...
            child: Row(children: [
              ...
              const Spacer(),
              Text('$countÃ—', style: GoogleFonts.orbitron(fontSize: 11, color: _cyan)),
            ]),
          );
        }).toList(),
      ],
