...
def _fake_config_get(key: str, default=None):
    values = {
        "failover.profiles": _TEST_PROFILES,
        "failover.cooldown_backoff_base": 60,
        "failover.max_retries_per_profile": 2,
    }
...
def profile_manager():
    ...
    }, clear=False), patch.object(configuration, "get", side_effect=_fake_config_get):
        pm = ProfileManager()
        # Reset state
        pm._cooldowns = {}
        pm._failure_counts = {}
