"""Tests for agent loop helpers — _detect_admin_intent, _compute_final_metrics,
and _append_tool_results. Uses direct imports to avoid loading the full app stack."""
