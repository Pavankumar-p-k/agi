...
_TOOL_NAME_MAP = {
    ...
    "edit_file": "edit_file",
    "undo": "undo_edit_file",
    "undo_edit_file": "undo_edit_file",
    "batch_edit": "batch_edit_file",
    "batch_edit_file": "batch_edit_file",
    "bulk_edit": "batch_edit_file",
    "watch": "watch_file",
    ...
    "find_code": "semantic_search",
    "search_code": "semantic_search",
    "shell": "shell",
    "shell_command": "shell",
    "persistent_shell": "shell",
    "refactor": "refactor",
    ...
    "background_task": "sessions_spawn",
    # Browser tool aliases
    "navigate": "browser_navigate",
    "browser_navigate": "browser_navigate",
    "browser_find": "browser_find",
    "find_element": "browser_find",
    "browser_find_interactive": "browser_find_interactive",
    "find_interactive": "browser_find_interactive",
    "click_element": "browser_click",
    "browser_click": "browser_click",
    "fill_field": "browser_fill",
    "browser_fill": "browser_fill",
    "type_text": "browser_fill",
    "press_key": "browser_press",
    "browser_press": "browser_press",
    "browser_snapshot": "browser_snapshot",
    "dom_snapshot": "browser_snapshot",
    "current_url": "browser_get_url",
    "browser_get_url": "browser_get_url",
    "page_title": "browser_get_title",
    "browser_get_title": "browser_get_title",
    "screenshot": "browser_screenshot",
    "browser_screenshot": "browser_screenshot",
    "page_state": "browser_current_state",
    "browser_current_state": "browser_current_state",
    "vision_browser": "vision_browser",
    "browser_health": "browser_health",
    "browser_get_history": "browser_get_history",
    "nav_history": "browser_get_history",
    ...
    "wait_visible": "browser_wait_visible",
    "browser_wait_visible": "browser_wait_visible",
    "wait_text": "browser_wait_text",
    "browser_wait_text": "browser_wait_text",
    "wait_interactive": "browser_wait_interactive",
    "browser_wait_interactive": "browser_wait_interactive",
    "shadow_query": "browser_shadow_query",
    "browser_shadow_query": "browser_shadow_query",
    "evaluate_js": "browser_evaluate",
    "browser_evaluate": "browser_evaluate",
    # Workspace provider tools
    "workspace_snapshot": "workspace_snapshot",
    "snapshot": "workspace_snapshot",
    "desktop_snapshot": "workspace_snapshot",
    "workspace_active_window": "workspace_active_window",
    "active_window": "workspace_active_window",
    "workspace_clipboard": "workspace_clipboard",
    "clipboard": "workspace_clipboard",
    "get_clipboard": "workspace_clipboard",
    "workspace_processes": "workspace_processes",
    "processes": "workspace_processes",
    "list_processes": "workspace_processes",
    "workspace_system_stats": "workspace_system_stats",
    "system_stats": "workspace_system_stats",
    "sys_stats": "workspace_system_stats",
    # GitHub provider tools
    "github_status": "github_status",
    "git_status": "github_status",
    "repo_status": "github_status",
    "github_clone": "github_clone",
    "clone_repo": "github_clone",
    "git_clone": "github_clone",
    "github_pull": "github_pull",
    "git_pull": "github_pull",
    ...
    "git_diff": "github_diff",
    "github_pr_list": "github_pr_list",
    "pr_list": "github_pr_list",
    "list_prs": "github_pr_list",
    ...
    "list_issues": "github_issue_list",
    "github_release": "github_release",
    "create_release": "github_release",
    "release_create": "github_release",
    # Email provider tools
    "email_send": "email_send",
    "email_send_email": "email_send",
}
...
def _parse_xml_invoke(inv_match) -> ToolBlock | None:
    ...
    from core.tools.schemas import function_call_to_tool_block
