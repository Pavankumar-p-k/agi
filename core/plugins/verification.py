...
class ManifestVerifier:
    """SHA-256 manifest verification with optional GPG signature support.

    Phase 3c: Manifest verification for plugins.
    Detects tampering of plugin.json files and optionally verifies
    remote plugin downloads via checksums.
    """
    ...
    def verify_manifest_integrity(self, manifest_path: str) -> bool:
        ...
        # Normalize: sort keys, no trailing whitespace
