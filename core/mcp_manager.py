...
class McpManager:
    ...
    async def _connect_stdio(self, server_id: str, name: str, command: str, args: list[str], env: dict[str, str]) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.debug("mcp_manager stdio init failed: %s", _e)
                await stack.aclose()
                raise
            tools = []
    ...
    async def _connect_sse(self, server_id: str, name: str, url: str) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.debug("mcp_manager sse init failed: %s", _e)
                await stack.aclose()
                raise
            tools = []
            for tool in tools_result.tools:
    ...
    async def connect_all_enabled(self):
        ...
        from core.database_models import McpServer, get_sync_db
    ...
    async def _reconnect_builtin(self, server_id: str) -> bool:
        ...
        try:
            ...
            logger.warning("[core.mcp_manager] src.builtin_mcp not available: %s", e)
            return False
